...
const messages = {
    en: {
        login: {
            ...
            requiredFields: "Please complete both fields"
        },
        register: {
    ...
    es: {
        login: {
            ...
            requiredFields: "Por favor, completa ambos campos."
        },
        register: {
            title: "Crear Cuenta",
            usercode: "Código de usuario",
    ...
    ca: {
        login: {
            ...
            requiredFields: "Si us plau, completa tots dos camps."
        },
        register: {
            title: "Crear Compte",
            usercode: "Codi d'usuari",
    ...
    fr: {
        login: {
            ...
            requiredFields: "Veuillez remplir les deux champs"
        },
        register: {
